...
def evaluation(refTrainFile, refTestFile, baseFile):
    ...
    print("F-Beta Score: " + str(fbeta_score(refTestY, yRefLogPreds, average='weighted', beta=0.5)))
    print("Accuracy: " + str(accuracy_score(refTestY, yRefLogPreds)))
    print("Precision: " + str(precision_score(refTestY, yRefLogPreds, average='weighted', zero_division=1)))
    print("Recall: " + str(recall_score(refTestY, yRefLogPreds, average='weighted', zero_division=1)))
    p, r, t = precision_recall_curve(refTestY, yRefLogPreds)
    print("AUPRC: " + str(auc(r, p)))
    print()
    
    print("Baseline Model Metrics: ")
    print("F-Beta Score: " + str(fbeta_score(refTestY, yBaseLogPreds, average='weighted', beta=0.5)))
    print("Accuracy: " + str(accuracy_score(refTestY, yBaseLogPreds)))
    print("Precision: " + str(precision_score(refTestY, yBaseLogPreds, average='weighted', zero_division=1)))
    print("Recall: " + str(recall_score(refTestY, yBaseLogPreds, average='weighted', zero_division=1)))
    p, r, t = precision_recall_curve(refTestY, yBaseLogPreds)
    print("AUPRC: " + str(auc(r, p)))
    print()
    
    #Random Forest Models
    refRFModel = RandomForestClassifier(n_estimators=100, verbose=0).fit(refTrainX, refTrainY)
    baseRFModel = RandomForestClassifier(n_estimators=100, verbose=0).fit(baseTrainX, baseTrainY)
    yRefRFPreds = refRFModel.predict(refTestX)
    yBaseRFPreds = baseRFModel.predict(refTestX)
    
    print("---Random Forest Models---")
    print("Reference Model Metrics:  ")
    print("F-Beta Score: " + str(fbeta_score(refTestY, yRefRFPreds, average='weighted', beta=0.5)))
    print("Accuracy: " + str(accuracy_score(refTestY, yRefRFPreds)))
    print("Precision: " + str(precision_score(refTestY, yRefRFPreds, average='weighted', zero_division=1)))
    print("Recall: " + str(recall_score(refTestY, yRefRFPreds, average='weighted', zero_division=1)))
    p, r, t = precision_recall_curve(refTestY, yRefRFPreds)
    print("AUPRC: " + str(auc(r, p)))
    print()
    
    print("Baseline Model Metrics: ")
    print("F-Beta Score: " + str(fbeta_score(refTestY, yBaseRFPreds, average='weighted', beta=0.5)))
    print("Accuracy: " + str(accuracy_score(refTestY, yBaseRFPreds)))
    print("Precision: " + str(precision_score(refTestY, yBaseRFPreds, average='weighted', zero_division=1)))
    print("Recall: " + str(recall_score(refTestY, yBaseRFPreds, average='weighted', zero_division=1)))
